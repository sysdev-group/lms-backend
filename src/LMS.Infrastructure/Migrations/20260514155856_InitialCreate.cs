        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrollmentOpenDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EnrollmentCloseDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    GradeSubmissionDeadline = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TurnitinEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    AllowStudentsViewReport = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DroppedById = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimetableSessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimetableSessions_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimetableSessions_Semesters_SemesterId",
                        column: x => x.SemesterId,
                        principalTable: "Semesters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimetableSessions_Users_LecturerId",
                        column: x => x.LecturerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LecturerFeedback = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimetableSessionId = table.Column<Guid>(type: "uuid", nullable: false),
                    LecturerId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceSessions_TimetableSessions_TimetableSessionId",
                        column: x => x.TimetableSessionId,
                        principalTable: "TimetableSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    OverriddenById = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_Users_OverriddenById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_OverriddenById",
                table: "AttendanceRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSessions_TimetableSessionId",
                table: "AttendanceSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimetableSessions_CourseId",
                table: "TimetableSessions",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_TimetableSessions_LecturerId",
                table: "TimetableSessions",
                column: "LecturerId");

            migrationBuilder.CreateIndex(
                name: "IX_TimetableSessions_SemesterId",
                table: "TimetableSessions",
                column: "SemesterId");
